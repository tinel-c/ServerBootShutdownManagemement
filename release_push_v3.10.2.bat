...
gh release create v3.10.2 --title "v3.10.2 - Irrigation system GUI" --notes-file docs/releases/RELEASE_NOTES_v3.10.2.md
if errorlevel 1 (
  echo.
  ...
  echo   Paste content from docs/releases/RELEASE_NOTES_v3.10.2.md
  exit /b 1
)
