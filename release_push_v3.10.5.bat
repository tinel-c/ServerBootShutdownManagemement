...
gh release create v3.10.5 --title "v3.10.5 - Irrigation rain-smart schedule & triggers" --notes-file RELEASE_NOTES_v3.10.5.md
if errorlevel 1 (
  echo.
  ...
  echo   Paste content from RELEASE_NOTES_v3.10.5.md
  exit /b 1
)
