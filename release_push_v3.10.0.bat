...
gh release create v3.10.0 --title "v3.10.0 - SMS Multi-Reply and Comprehensive HELP" --notes-file RELEASE_NOTES_v3.10.0.md
if errorlevel 1 (
  echo.
  ...
  echo   Paste content from RELEASE_NOTES_v3.10.0.md
  exit /b 1
)
