...
| `device/energy-consumers/` | Tuya + Tasmota smart meters → `energy/consumers/*`, flow **840** ([README](energy-consumers/README.md), [agent playbook](../docs/ENERGY_CONSUMER_ADD.md)) |
