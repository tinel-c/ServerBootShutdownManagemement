...
gh release create v3.10.1 --title "v3.10.1 - Irrigation tab UI layout" --notes-file docs/releases/RELEASE_NOTES_v3.10.1.md
if errorlevel 1 (
  echo.
  ...
  echo   Paste content from docs/releases/RELEASE_NOTES_v3.10.1.md
  exit /b 1
)
