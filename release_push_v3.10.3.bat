...
gh release create v3.10.3 --title "v3.10.3 - Irrigation I1–I12 and dashboard areas" --notes-file RELEASE_NOTES_v3.10.3.md
if errorlevel 1 (
  echo.
  ...
  echo   Paste content from RELEASE_NOTES_v3.10.3.md
  exit /b 1
)
